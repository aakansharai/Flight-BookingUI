...
public class OneWayFlightListAdapter extends RecyclerView.Adapter<OneWayFlightListAdapter.MyViewHolder> {

    ArrayList<FlightList> flightList;
    Context ctx;

    public OneWayFlightListAdapter(ArrayList<FlightList> flightList, Context ctx) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.one_way_flight_list_item, parent, false);
